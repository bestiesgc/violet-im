		...
		return function (Module) {
			...
			;(function () {
				...
				if (a.instantiateWasm)
					try {
						...
						return (
							n('Module.instantiateWasm callback failed with error: ' + f), !1
						)
					}
				;(function () {
					return q ||
			...
			function G(b) {
				return function () {
					...
					if (c === h)
						throw (
							((c = t(a._olm_outbound_group_session_last_error(arguments[0]))),
							Error('OLM.' + c))
						)
					return c
				}
			...
			function P(b) {
				return function () {
					...
					if (c === h)
						throw (
							((c = t(a._olm_inbound_group_session_last_error(arguments[0]))),
							Error('OLM.' + c))
						)
					return c
				}
			...
			function R(b) {
				return function () {
					...
					if (c === h)
						throw (
							((c = t(a._olm_pk_encryption_last_error(arguments[0]))),
							Error('OLM.' + c))
						)
					return c
				}
			...
			function T(b) {
				return function () {
					...
					if (c === h)
						throw (
							((c = t(a._olm_pk_decryption_last_error(arguments[0]))),
							Error('OLM.' + c))
						)
					return c
				}
			...
			function Wa(b) {
				return function () {
					...
					if (c === h)
						throw (
							((c = t(a._olm_pk_signing_last_error(arguments[0]))),
							Error('OLM.' + c))
						)
					return c
				}
			...
			function V(b) {
				return function () {
					...
					if (c === h)
						throw (
							((c = t(a._olm_sas_last_error(arguments[0]))), Error('OLM.' + c))
						)
					return c
				}
			}
